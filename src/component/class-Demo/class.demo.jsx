...
export function ClassDemoComponent(){
    const[cities] = useState(["Delhi","Hyd","Mumbai","Chenni","Bangalore"]);
    ...
    function handleSortClick(e){
     ...
     return(
        <div className="container-fluid mb-3">
          <h2 className="mt-3">Cites List <button onClick={handleSortClick} className="btn btn-success"><span className={buttonClass}></span></button></h2>
          <ol>
            {
                cities.map(city=>
                       <li key={city}>{city}</li>
